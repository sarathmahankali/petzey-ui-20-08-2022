...
export class VetdialogComponent implements OnInit {
  ...
  constructor(private vetService: VetProfileService, private fb: FormBuilder, @Inject(MAT_DIALOG_DATA) public data:any, private dialogRef: MatDialogRef<VetdialogComponent>) { }
  ngOnInit(): void {
